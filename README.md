...
I am a mobile developer with 2+ years of experience to design and developing iOS and Android apps using `flutter` Also I enjoy learning new things in my free time. Currently, I am learning `Android / Kotlin` in my free time and love to be deeper in `dart` and `flutter`.
...
| :-: | :-: | :-: | :-: |
| [Ketolife]() | [Codehub](https://github.com/codehub-ir/codehub-mobile) | [Barber booking]() | [Meal planner]() |
